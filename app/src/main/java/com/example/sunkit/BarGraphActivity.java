...
public class BarGraphActivity extends AppCompatActivity {
    ...
    private static final String URL = "http://192.168.1.29:80/Charts.php";
    String[] lastnameArray = new String[100];
    int[] winArray = new int[100];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(BarGraphActivity.this, MainActivity.class);
    ...
    public void loadIntoListView(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            NoOfEmp.add(new BarEntry(winArray[i], i));
        }
/*
...
*/
        ...
        BarDataSet bardataset = new BarDataSet(NoOfEmp, "Number of Wins");
